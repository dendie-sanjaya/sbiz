		...
		<form action="index.php" method="post">
			<table width="100%" border="0">
				<tr>
					...
					<td>
						<input type="text" name="dateTo" id="dateTo" value="" readonly style="width:200px"  />
					</td>							
				</tr>							
				<tr>
					<td>NAMA PROMO</td>
					<td>
						<input type="text" name="keyword" id="keyword" value="<?php isset($_REQUEST['keyword']) ? $_REQUEST['keyword'] : '' ?>"  />				
					</td>					
					<td>PLATFORM MARKET</td>
					<td>
			...
			<table width="100%" border="1">
				<thead>			
					<tr>
						...
						<th align="center" width="30%">NAMA PROMO</th>
