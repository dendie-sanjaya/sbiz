...
<table width="100%">
  <tr>
  	 <td valign="top">
		<h1>EDIT DAFTAR BARANG BUNDLING</h1>  	 	
  	 </td>
...
<table width="100%">
	...
	<tr>
		...
		<td>
			<div id="divFeeSalesLabel" style="height: 25px; font-weight: bold">0</div>
		</td>
	</tr>			
		...
		<table width="100%" border="1">
					...
					<tr>
						...
						<td align="center" valign="top">
							<table width="100%" style="border: 0px; font-size: 11px">
							  ...
							  <tr>
							  	<td  style="border: 0px">Harga Normal * Kuantiti</td>
							  	<td  style="border: 0px">: 
							  		<span id="price_normal_qty_label_<?php echo $val['id'] ?>"><?php echo number_format(($val['price_normal'] * $val['qty']),0,'','.') ?></span> 
							  	</td>
							  </tr>		
							  ...
							  <tr>
							  	...
							  	<td  style="border: 0px">: 
							  		<input type="text" onkeyup="priceBundling($('#discount_type_<?php echo $val['id'] ?>').val(),$('#discount_val_<?php echo $val['id'] ?>').val(),'<?php echo $val['price_normal'] ?>','price_<?php echo $val['id'] ?>','price_bundling_label_<?php echo $val['id'] ?>','price_bundling_label_total_<?php echo $val['id'] ?>',$('#qty_<?php echo $val['id'] ?>').val(),'price_normal_qty_label_<?php echo $val['id'] ?>')" name="discount_val_<?php echo $val['id'] ?>" id="discount_val_<?php echo $val['id'] ?>" value="<?php echo $val['discount_type'] == '0' ? $val['discount_percent'] : $val['discount_nominal']  ?>" style="width: 90px"><br /> 
							  		&nbsp;&nbsp;<select name="discount_type_<?php echo $val['id'] ?>" id="discount_type_<?php echo $val['id'] ?>" style="width: 90px" onchange="priceBundling($('#discount_type_<?php echo $val['id'] ?>').val(),$('#discount_val_<?php echo $val['id'] ?>').val(),'<?php echo $val['price_normal'] ?>','price_<?php echo $val['id'] ?>','price_bundling_label_<?php echo $val['id'] ?>','price_bundling_label_total_<?php echo $val['id'] ?>',$('#qty_<?php echo $val['id'] ?>').val(),'price_normal_qty_label_<?php echo $val['id'] ?>')">
							  ...
							  <tr>
							  	...
							  	<td  style="border: 0px">: 
							  	    <input type="number" min="1" onchange="priceBundling($('#discount_type_<?php echo $val['id'] ?>').val(),$('#discount_val_<?php echo $val['id'] ?>').val(),'<?php echo $val['price_normal'] ?>','price_<?php echo $val['id'] ?>','price_bundling_label_<?php echo $val['id'] ?>','price_bundling_label_total_<?php echo $val['id'] ?>',$('#qty_<?php echo $val['id'] ?>').val(),'price_normal_qty_label_<?php echo $val['id'] ?>')" name="qty_<?php echo $val['id'] ?>" id="qty_<?php echo $val['id'] ?>" value="<?php echo $val['qty'] ?>" style="width: 50px; height: 30px; text-align: center;"> 								  		
							  	</td>
							  </tr>		
							  <tr>
						...
						<td align="center" valign="top">
							<input type="text" onkeyup="grandTotalFeeSales()" id="fee_sales_<?php echo $val['id'] ?>" name="fee_sales_<?php echo $val['id'] ?>" value="<?php echo $val['fee_sales'] ?>"  style="width: 70px">
						</td>
					</tr>	
				<?php $i++; ?>
				<?php endwhile; ?>
			...
			<thead>			
				<tr>
					...
					<th><div id="divHargaBundlingLabelFooter"><?php echo number_format($totalPrice,0,'','.') ?></div></th>
					<th><div id="divFeeSalesLabelFooter"><?php echo number_format($totalFeeSales,0,'','.') ?></div></th>
				</tr>	
